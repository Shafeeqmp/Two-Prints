    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card) => (
            <div key={card.id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="mt-16 p-8 bg-white rounded-xl shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">Crisp details and vibrant colors with professional offset printing technology.</p>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">Quick production times without compromising on quality or attention to detail.</p>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">High-quality printing services at competitive prices with volume discounts.</p>
            </div>
          </div>
        </div>
      </div>
